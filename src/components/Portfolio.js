                    ...
                    <div className='swiper-wrapper'>
                        <div className='portfolio__content grid swiper-slide'>
                            ...
                            <div className='portfolio__data'>
                                ...
                                <a href="https://netflix-clone-2d696.web.app/" className='button button__flex button__small portfolio__button'>Demo <i class="icofont-caret-right button__icon"></i></a>
                            </div>
                        </div>
                        <div className='portfolio__content grid swiper-slide'>
                            <img src='assets/images/disney.png' className='portfolio__img'></img>
                            <div className='portfolio__data'>
                                <h3 className='portfolio__title'>Disney</h3>
                                <p className='portfolio__description'>React using Firebase as database with Auth and Firestore</p>
                                <a href="https://netflix-clone-2d696.web.app" className='button button__flex button__small portfolio__button'>Demo <i class="icofont-caret-right button__icon"></i></a>
                            </div>
                        </div>
                        <div className='portfolio__content grid swiper-slide'>
                            <img src='assets/images/linkedin.png' className='portfolio__img'></img>
                            <div className='portfolio__data'>
                                <h3 className='portfolio__title'>Linked In</h3>
                                <p className='portfolio__description'>React using Firebase, Redux, Styled Components</p>
                                <a href=" https://linkedin-clone-363bb.web.app" className='button button__flex button__small portfolio__button'>Demo <i class="icofont-caret-right button__icon"></i></a>
                            </div>
                        </div>
                        <div className='portfolio__content grid swiper-slide'>
                        ...
                        <div className='portfolio__content grid swiper-slide'>
                            <img src='assets/images/facebook.png' className='portfolio__img'></img>
                            <div className='portfolio__data'>
                                <h3 className='portfolio__title'>Facebook</h3>
                                <p className='portfolio__description'>React using Firebase, Redux</p>
                                <a href="https://linkedin-clone-363bb.web.app/" className='button button__flex button__small portfolio__button'>Demo <i class="icofont-caret-right button__icon"></i></a>
                            </div>
                        </div>
                        <div className='portfolio__content grid swiper-slide'>
